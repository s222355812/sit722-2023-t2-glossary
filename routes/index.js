...
const itemList =[
  ...
  {
    'id':16,'Term':'Infrastructure as Code (IaC)', 'Description': 'A software engineering approach that allows infrastructure provisioning, configuration, and management to be defined and managed using code, typically in a high-level domain-specific language','Referance':'M. COUPLAND, DEVOPS Adoption Strategies: Principles, Processes,Tools, and Trends. S.l.: PACKT PUBLISHING LIMITED, 2021.'
  },
  {
  ...
  {
    'id':19,'Term':'Service-Level Agreement (SLA)', 'Description': 'SLA is an explicit or implicit contract with your users that includes consequences of meeting (or missing) the SLOs they contain.They signify the business factor that binds the customer and service provider and represent the consequences of what happens when availability or customer','Referance':'M. COUPLAND, DEVOPS Adoption Strategies: Principles, Processes,Tools, and Trends. S.l.: PACKT PUBLISHING LIMITED, 2021.'
  },
  {
